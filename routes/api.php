...
Route::get('get-study-programs', [StudyProgramController::class, 'getStudyPrograms'])->name('study-programs.get');
Route::resource('study-programs', StudyProgramController::class);
Route::resource('code-referals', CodeReferalController::class);
Route::post('code-referals/check', [CodeReferalController::class, 'check'])->name('code-referals.check');
